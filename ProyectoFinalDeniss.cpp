...
int main()
{
	...
	if(desC=='c'){
		...
		switch(desD){
			...
			case 'c':{
				system("cls");
				cout<<"Has perdido una vida \n¡Mal! Quedarte quieto/a cuando te atrapan o estas en peligro por obvias razones no es la opcion correcta.-_-"<<endl;
				system("pause");
				cout<<"El hormre saca su arma y te apunta..:)."<<endl;
				system("pause");
				break;
			}
			case 'd':{
	...
	if(desD=='a'){
		...
		switch(desE){
			...
			case 'a':{
				system("cls");
				cout<<"HAS LOGRADO ESCAPAR DE LA CASA!!"<<endl;
				system("pause");
				cout<<"FELICIDADES HAS LOGRADO ESCAPAR CON VIDA"<<endl;
				system("pause");
				break;
			}
			case 'b':{
				system("cls");
				cout<<"TE HAN ENCONTRADO Y TE HAN ASESINADO!!"<<endl;
				system("pause");
				cout<<"PUEDES VOLVER A INTENTARLO, SUERTE PARA LA PROXIMA"<<endl;
				system("pause");
				break;
			...
			case 'c':{
				system("cls");
				cout<<"TE HAN ENCONTRADO ESCONDIDO/A Y TE HAN DADO PLOMO XD"<<endl;
				system("pause");
				cout<<"PUEDES VOLVER A INTENTARLO, SUERTE PARA LA PROXIMA.):"<<endl;
				system("pause");
				break;
